...
ALTER TABLE [emprunt] ADD FOREIGN KEY ([reference_emprunt]) REFERENCES [inscrit] ([id_inscrit])
GO

ALTER TABLE [emprunt] ADD FOREIGN KEY ([reference_emprunt]) REFERENCES [exemplaire] ([id_exemplaire])
GO
